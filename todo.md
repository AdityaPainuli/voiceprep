## Things to do - 
1. Mute microphone when start of session.
2. Add valid credit based system (with stripe pricing) ~ later
3. Debug the repeating issue happening after long session.
