        ...
        <div className="h-full w-full bg-[#1e1e1e] border-l border-gray-700 flex flex-col">
                    ...
                    {isDiffMode ? (
                        ...
                        <>
                            <button
                                ...
                                className={`px-3 py-1.5 text-white text-xs font-bold rounded transition-colors flex items-center gap-2 ${isRunning
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-white text-xs font-bold rounded transition-colors flex items-center gap-2 ${isSubmitting
            ...
            <div className="flex-1 overflow-hidden flex flex-col">
                ...
                <div className="h-1/3 bg-black border-t border-gray-700 p-4 overflow-auto font-mono text-sm shrink-0">
                    ...
                    {output ? (
                        <pre className={`${isError ? 'text-red-400' : 'text-green-400'} whitespace-pre-wrap`}>{output}</pre>
                    ) : (
