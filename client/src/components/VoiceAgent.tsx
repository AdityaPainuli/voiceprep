        ...
        <div className="h-full flex flex-col bg-gray-900 text-white p-6 relative overflow-hidden">
            ...
            <div className="flex-1 relative z-10 flex flex-col items-center justify-center min-h-[200px]">
                ...
                <div className="relative">
                    {/* Outer glow rings */}
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] rounded-full border border-blue-500/20 transition-all duration-1000 ${isSessionActive ? 'scale-110 opacity-100' : 'scale-90 opacity-0'}`} />
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[160px] h-[160px] rounded-full border border-purple-500/20 transition-all duration-1000 delay-100 ${isSessionActive ? 'scale-110 opacity-100' : 'scale-90 opacity-0'}`} />

                    {/* Core Circle */}
                    <div className={`relative w-32 h-32 rounded-full flex items-center justify-center transition-all duration-500 ${isSessionActive
            ...
            <div className="relative z-10 mt-auto flex flex-col gap-3">
                {isSessionActive && toggleMute && (
                    <button
                        onClick={toggleMute}
                        className={`w-full py-3 px-4 rounded-xl font-semibold shadow-lg transition-all flex items-center justify-center gap-2 ${isMuted
                        ...
                        {isMuted ? (
                            <>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12.732a1 1 0 01-1.707.707L4.586 14H2a1 1 0 01-1-1V7a1 1 0 011-1h2.586l3.707-3.439a1 1 0 011.09-.485zM16 10a6 6 0 00-3.815-5.586 1 1 0 011.176-1.628A8 8 0 0116 10zM12 10a2 2 0 00-1.815-1.992 1 1 0 01.362-1.966A4 4 0 0112 10z" clipRule="evenodd" />
                                </svg>
                                Unmute Microphone
                            </>
                        ) : (
                ...
                <button
                    ...
                    className={`w-full py-4 px-6 rounded-xl font-bold shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] ${isSessionActive
